...
interface Window {
	electronAPI: {
		...
		videoEncoderEnd: (
			sessionId: string,
		) => Promise<{ success: boolean; tempVideoPath?: string; error?: string }>;
		videoEncoderCancel: (sessionId: string) => Promise<{ success: boolean; error?: string }>;
		...
		videoEncoderReadAndDelete: (
			filePath: string,
		) => Promise<{ success: boolean; data?: ArrayBuffer; error?: string }>;
		videoEncoderConnectTransport: (port: number) => Promise<{
