...
export interface ExportProgress {
	...
	fps?: number; // frames rendered per second (rolling average)
	phase?: "extracting" | "audio" | "finalizing";
	audioEngine?: "ffmpeg" | "realtime" | "webcodecs"; // which audio processor is active
	workerEngine?: "worker-pool" | "single-thread"; // whether OffscreenCanvas workers are active
	videoEncoder?: // which video encoder is active
		| "h264_nvenc"
		| "h264_qsv"
		| "h264_amf"
		| "h264_videotoolbox"
