...
let blurScratchCanvas: OffscreenCanvas | null = null;
let blurScratchCtx: OffscreenCanvasRenderingContext2D | null = null;
...
function renderBlur(
	...
	if (!blurScratchCanvas || !blurScratchCtx) {
		blurScratchCanvas = new OffscreenCanvas(sw, sh);
